...
FE = ["FE_1", "FE_2", "FE_3", "FE_4", "FE_6", "FE_7", "FE_8", "FE_9", "FE_11", "FE_12", "FE_13"]
    ...
    try:
        ...
        for fold, (train_idx, valid_idx) in enumerate(kf.split(X, y)):
            if fold > 1:
                ...
                model.fit(X_train, y_train, eval_set=(X_valid, y_valid), early_stopping_rounds=300, use_best_model=True)
        ...
        save.to_csv("backup_cb.csv", index=False)
    except:
